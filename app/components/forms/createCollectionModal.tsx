  ...
  if (products.length === 0)
    return (
      <div
        ...
        onClick={onClose}
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/50 w-fit max-w-4xl max-h-[90vh] overflow-y-auto">
          <div className="flex flex-col justify-center items-center space-y-5 h-full">
            <ExclamationTriangleIcon className="h-12 w-12 text-red-600" />
            <p className="text-xl text-red-600 font-bold">
              محصولی برای ایجاد کالکشن وجود ندارد
            </p>
